...
\begin{document}
    ...
    \begin{frame}{Let Expressions: Dynamic Semantics}
        \begin{itemize}
            \item \code{let z = 0 + 1 in z + 41}
            \item \code{let z = 1 in z + 41}
            \item \code{1 + 41}
            \item \code{42}
        \end{itemize} 
    \end{frame}
    ...
    \begin{frame}{Let Expressions: Dynamic Semantics}
        \begin{itemize}
            \item \code{let y = 25 in let z = y * 3 in z - y}
            \item \code{let z = y * 3 in z - y }
            \item \code{let z = 25 * 3 in z - 25}
            \item \code{let z = 75 in z - 25}
            \item \code{z - 25}
            \item \code{75 - 25}
            \item \code{50}
        \end{itemize} 
